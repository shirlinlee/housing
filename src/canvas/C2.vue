    ...
    data(){
      return {
        ...
        slides:[
          ...
          { name:'雙層配筋', srcName:'6-2-2.png', text:'<div class="engrg-des"><h3>雙層配筋</h3><p class="main-p dot">外牆 15 公分</p><p class="main-p dot">符合國家標準 CNS560 要求，具有無輻射性污染證明</p></div>'},
