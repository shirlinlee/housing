...
(lib.sprite31 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({alpha:1,startPosition:19},19).wait(1026));
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.instance.parent = this;
	this.instance.setTransform(84.7,158.6);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1045));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(764.7,542.6,669,416);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"/static/images/005_atlas_.png?1531734413637", id:"005_atlas_"}
	],
	preloads: []
};
