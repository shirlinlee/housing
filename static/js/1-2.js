...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.instance.parent = this;
	this.instance.setTransform(627.2,281.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(300));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(860.2,555.5,540,401);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"/static/images/004_atlas_.png?1531734381114", id:"004_atlas_"}
	],
	preloads: []
};
