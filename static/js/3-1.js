(function (cjs, an) {
	...
	if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
		...
		this.instance.parent = this;
		this.instance.setTransform(35,150.3);
	
		this.timeline.addTween(cjs.Tween.get(this.instance).wait(414));
	
	}).prototype = p = new cjs.MovieClip();
	p.nominalBounds = new cjs.Rectangle(435,534.3,738,400);
	// library properties:
	lib.properties = {
		...
		opacity: 1.00,
		manifest: [
			{src:"/static/images/image157.png?1532929249341", id:"image157"}
		],
		preloads: []
	};
	...
	})(createjs = createjs||{}, AdobeAn = AdobeAn||{}, thisPage = '3-1');
