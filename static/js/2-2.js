...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.instance.parent = this;
	this.instance.setTransform(698.4,258);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(300));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(818.5,587.1,584.6,334);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"/static/images/007_atlas_.png?1531734560252", id:"007_atlas_"}
	],
	preloads: []
};
